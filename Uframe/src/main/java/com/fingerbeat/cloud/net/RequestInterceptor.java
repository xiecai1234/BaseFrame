...
public class RequestInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (BaseUserHelper.getInstance().isLogin()) {
            String accessToken = BaseUserHelper.getInstance().getAccessToken();
            String tokenType = BaseUserHelper.getInstance().getTokenType();
